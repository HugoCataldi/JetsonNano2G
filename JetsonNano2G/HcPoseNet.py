...
###############################
# Programme   : HcPoseNet <- Fait a partir de l'exemple posenet.py du projet github 'jetson-inference'
#
...
#               la posture est afficher sur la fenetre de la camera.
#               Il y a 4 posture : AVANCER, STOP, GAUCHE, DROITE
#               
